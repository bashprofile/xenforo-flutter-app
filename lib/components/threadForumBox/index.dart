...
class _ThreadForumBoxState extends State<ThreadForumBox> {
  ...
  Widget build(BuildContext context) {
    return new Container(
      ...
      child: new ListTile(
        title: new Text(widget.forumData.title,
            style: TextStyle(
                color: Colors.black,
        ...
        subtitle: Row(children: <Widget>[
          ...
          new Text(
            DateTime.fromMicrosecondsSinceEpoch(widget.forumData.date)
                    .day
                    .toString() +
                '-' +
                DateTime.fromMicrosecondsSinceEpoch(widget.forumData.date)
